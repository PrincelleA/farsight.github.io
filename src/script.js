...
function loadStars(data) {
	...
	// Apply texture
	const loader = new THREE.TextureLoader().load("https://princellea.github.io/star.png");
...
// Apply texture
var texture = new THREE.TextureLoader().load("https://princellea.github.io/milkyway.jpg");
